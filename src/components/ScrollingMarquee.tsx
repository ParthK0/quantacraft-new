...
export default function ScrollingMarquee() {
  return (
    <div className="relative w-full z-[40] overflow-hidden bg-gradient-to-r from-blue-900 via-emerald-800 to-blue-900 border-y-4 border-white/30 shadow-[0_0_40px_rgba(0,255,150,0.4)] py-2">
